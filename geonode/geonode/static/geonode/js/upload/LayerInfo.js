...
define(function (require, exports) {
    ...
    LayerInfo.prototype.markError = function (error, status) {
        var error = (error != undefined ? error : 'Erro inesperado!');
        alert("Erro inesperado com o servidor!\nTente enviar o(s) arquivo(s) novamente.");
        location.reload();
    };
    ...
    LayerInfo.prototype.markStart = function () {
        this.logStatus({
            msg: 'Seu upload foi iniciado...<div class="progress" id="prog"><div class="progress-bar progress-bar-success" style="width:0%"></div>',
            level: 'alert-success',
            empty: 'true'
        });
    };
    ...
    LayerInfo.prototype.displayUploadedLayerLinks = function(resp) {
        ...
        self.logStatus({
            msg: '<p>' + gettext('Enviado com sucesso!') + '<br/>' + msg_col + '<br/>' + a + '&nbsp;&nbsp;&nbsp;' + b + '&nbsp;&nbsp;&nbsp;' + c + '&nbsp;&nbsp;&nbsp;' + d + '&nbsp;&nbsp;&nbsp;' + e + '</p>',
            level: 'alert-success',
            empty: 'true'
        });
    };
            ...
            common.make_request({
                ...
                success: function (resp, status) {
                    ...
                    if (resp.status === "other") {
                        self.logStatus({
                            msg:'<p>' + gettext('Você precisa especificar mais informações para concluir seu upload') + '</p>',
                            level: 'alert-success',
                            empty: 'true'
                        });
