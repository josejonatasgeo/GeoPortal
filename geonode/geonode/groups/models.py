...
class GroupCategory(models.Model):
    ...
    class Meta:
        verbose_name_plural = _('Categorias do grupo')

    def __str__(self):
        return 'Categorias: {}'.format(self.name.encode('utf-8'))
...
class GroupProfile(models.Model):
    GROUP_CHOICES = [
        ("public", _("Corporativo")),
        ("public-invite", _("Corporativo-Convite")),
        ("private", _("Privado")),
    ]

    access_help_text = _('Corporativo: Qualquer usuario registrado pode ver e participar de um grupo corporativo.<br>'
                         'Corporativo(por convite):Qualquer usuario registrado pode ver o grupo. '
                         'Apenas usuarios convidados podem participar.<br>'
                         'Privado: Os usuarios registrados nao podem ver detalhes sobre o grupo.  '
                         'Apenas usuarios convidados podem participar.')
