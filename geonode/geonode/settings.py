...
# Examples: "http://media.lawrence.com", "http://GeoPortal/media/"
...
THEME_ACCOUNT_CONTACT_EMAIL = os.getenv(
    'THEME_ACCOUNT_CONTACT_EMAIL', 'suporte@geoflorestas.com.br'
)
...
#
SITEURL = os.getenv('SITEURL', "http://192.168.0.11:8000/")

DEFAULT_WORKSPACE = os.getenv('DEFAULT_WORKSPACE', 'adecoagro')
CASCADE_WORKSPACE = os.getenv('CASCADE_WORKSPACE', 'adecoagro')
