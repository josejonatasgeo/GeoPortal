...
class Profile(AbstractUser):
    ...
    profile = models.TextField(
        ...
        null=True,
        blank=True,
        help_text=_('apresente-se'))
    position = models.CharField(
        _('Cargo'),
        max_length=255,
        blank=True,
        null=True,
        help_text=_('funcao ou cargo da pessoa responsavel'))
    voice = models.CharField(_('Contato'), max_length=255, blank=True, null=True, help_text=_(
        'numero do telefone para falar com a organizacao ou o individuo responsavel'))
    '''fax = models.CharField(_('Facsimile'), max_length=255, blank=True, null=True, help_text=_(
        'numero do telefone ou fax da organizacao ou do individuo responsavel'))'''
    delivery = models.CharField(
        _('Endereco'),
        max_length=255,
        blank=True,
        null=True,
        help_text=_('endereco fisico ou de e-mail para contatar a organizacao ou individuo'))
    city = models.CharField(
        _('Cidade'),
        max_length=255,
        blank=True,
        null=True,
        help_text=_('cidade da localizacao'))
    area = models.CharField(
        _('Área administrativa'),
        max_length=255,
        blank=True,
        null=True,
        help_text=_('area de atuacao'))
