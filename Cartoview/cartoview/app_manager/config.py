...
'''
    Realiza a configuração dos aplicativos instalados, para tanto utiliza o arquivo apps.yml
    para especificar quais aplicativos estão instalados, suspensos e desativados.
    .. class:: AppsConfig(Collection)
    Parametros
    ==========
    Collection : lista de aplicativos que se encontra em apps.yml

    Retorno
    ========
    Aplicativo com suas configurações
'''
